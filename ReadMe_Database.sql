...
CREATE TABLE if not exists PlayerData(player_id int auto_increment PRIMARY KEY, team_id int,
...
ALTER TABLE PlayerData ADD FOREIGN KEY (team_id) REFERENCES TeamData(Team_id);
